...
public class GenericCURGatewayController {
    ...
    public @ResponseBody ResponseEntity<GetCurAttributesResponse>  processCURQuery(@RequestBody GetCurAttributes getCurAttributes ){
    	...
    	/*if(null!=curAttributesResponse){
    		ResponseEntity.ok();
    	}else{
    		ResponseEntity.badRequest();
    	}*/
    	return ResponseEntity.accepted().body(curAttributesResponse);
